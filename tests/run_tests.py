...
2. Running pytest from the tests/ directory
...
Examples:
    ...
    python tests/run_tests.py unit/test_exceptions.py -v
...
def install_minimal_stubs():
    ...
    class _FakeVaultClient:
        ...
        def set_secrets(self, s): pass
        def unsecret(self, data): return data
        @classmethod
